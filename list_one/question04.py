def __enunciate():
    print('''# Questão 04 - Faça um algoritmo que receba o salário de um funcionário e o percentual de aumento, 
# calcule e mostre o valor de aumento e o novo salário.''')
