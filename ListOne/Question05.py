# Faça um algoritmo que receba o salário-base de um funcionário, calcule e mostre o salário a receber, sabendo-se
# que esse funcionário tem gratificação de 5% sobre o salário-base e paga o imposto de 7% sobre o salário-base.
