def __enunciate():
    print('''# Questão 15.	Faça um algoritmo que receba um conjunto de valores inteiros e positivos e que calcule e mostre o maior e o menor valor do conjunto. Considere que:
#
