def __enunciate():
    print('''# Questão 05 - Faça um algoritmo que receba a idade, a altura e o peso de 25 pessoas. Calcule e mostre:
#
...
def entry():
    ...
    for i in range(25):
        ...
        height = float(input(f"Informe a altura {i + 1}ª da pessoa: "))
        weight = float(input(f"Informe o peso {i + 1}ª da pessoa: "))
